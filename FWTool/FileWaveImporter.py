...
class FileWaveImporter(FWTool):
    ...
    importer_variables = {
        ...
        "fw_fileset_activation_script": {
            "default": None,
            "required": False,
            "description": "The location of an activation script, needs to be in the imported folder.",
        },
        "fw_fileset_requirements_script": {
            "default": None,
            "required": False,
            "description": "The location of a requirements script, needs to be in the imported folder.",
        },
        "fw_fileset_preflight_script": {
            "default": None,
            "required": False,
            "description": "The location of a preflight script, needs to be in the imported folder.",
        },
        "fw_fileset_postflight_script": {
            "default": None,
            "required": False,
            "description": "The location of a postflight script, needs to be in the imported folder.",
        },
        "fw_fileset_preuninstallation_script": {
            "default": None,
            "required": False,
            "description": "The location of a preuninstallation script, needs to be in the imported folder.",
        },
        "fw_fileset_postuninstallation_script": {
            "default": None,
            "required": False,
            "description": "The location of a postuninstallation script, needs to be in the imported folder.",
        },
        "fw_fileset_verification_script": {
            "default": None,
            "required": False,
            "description": "The location of a verification script, needs to be in the imported folder.",
        },
    }
